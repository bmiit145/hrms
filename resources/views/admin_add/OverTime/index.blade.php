...
@section('content')
    ...
    color: white;">
                        ...
                        <form method="GET" action="{{ route('index.overtime') }}">
        ...
        <div class="offcanvas offcanvas-end" id="add-new-record" aria-modal="true" role="dialog">
            ...
            <div class="offcanvas-body flex-grow-1">
                <form action="{{ route('store.overtime') }}" method="post" id="password"
        ...
        <div class="offcanvas offcanvas-end" id="edit-new-record" aria-modal="true" role="dialog">
            ...
            <div class="offcanvas-body flex-grow-1">
                <form action="{{ route('edit.overtime') }}" method="post" id="password" enctype="multipart/form-data"
                    class="add-new-record pt-0 row g-3 fv-plugins-bootstrap5 fv-plugins-framework">
                    @csrf
        ...
        <div class="offcanvas offcanvas-end" id="deletemodal" aria-modal="true" role="dialog">
            ...
            <div class="offcanvas-body flex-grow-1">
                ...
                <form action="{{ Route('delete.overtime') }}" method="POST" id="delete-form">
                    @csrf
                    <input type="hidden" name="id" id="delete-id">
                    <div class="col-sm-12">
                        <button type="submit" class="btn waves-effect waves-light" style="background: linear-gradient(270deg, #b30000 0%, #ff6666 100%) !important;color: #f0f8ff;">Delete</button>
                        <button type="reset" class="btn btn-outline-secondary waves-effect"
                            data-bs-dismiss="offcanvas">Cancel</button>
                    </div>
                </form>
        ...
        <script>
            $(document).ready(function() {
                ...
                $(document).on('click', '.refresh-btn', function(event) {
                    event.preventDefault();
                    window.location.href = "{{ route('index.overtime') }}";
                });
