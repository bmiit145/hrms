    ...
    <div class="container-xxl flex-grow-1 container-p-y">
                            ...
                            <div class="dt-buttons btn-group flex-wrap">
                                <div class="dt-buttons btn-group flex-wrap">
                                    <a href="#" class="add_recode"><button
                                            ...
                                            style=" background: #7e4ee6;color: #f0f8ff;border: none !important;"
            ...
            <div class="offcanvas-body flex-grow-1">
                <form action="{{ route('admin.project.store') }}" method="post" id="myForm"
                    ...
                    <div class="col-sm-12 fv-plugins-icon-container">
                        ...
                        <label id="client_id-error" class="error remove-error" for="client_id"></label>
                    </div>
                    <div class="col-sm-12 fv-plugins-icon-container">
                        <div class="input-group input-group-merge">
                            <span id="basicFullname2" class="input-group-text"><i class="ri-user-line"></i></span>
                        ...
                        <label id="project_name-error" class="error remove-error" for="project_name"></label>
                    </div>
                    <div class="col-sm-12 fv-plugins-icon-container">
                        <div class="input-group input-group-merge">
                        ...
                        <label id="amount-error" class="error remove-error" for="amount"></label>
                    </div>
                    ...
                    <div class="col-sm-12 fv-plugins-icon-container">
                        <div class="input-group input-group-merge">
                            ...
                            <div class="form-floating form-floating-outline">
                                <input type="tel" class="form-control" placeholder="Enter Commission (%)"
                                    name="commission" id="commission"
                                    oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1')" />
                                <label for="basicFullname">Commission (%)</label>
                            </div>
                        </div>
                        <label id="commission-error" class="error remove-error" for="commission"></label>
                    </div>
                    ...
                    <div class="col-sm-12 fv-plugins-icon-container">
                        <div class="input-group input-group-merge">
                            ...
                            <div class="form-floating form-floating-outline">
                                <input type="tel" class="form-control" placeholder="Enter Tax (%)" name="tax"
                                    id="tex"
                                    oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1')" />
                                <label for="basicFullname">Tax (%)</label>
                            </div>
                        </div>
                        <label id="tex-error" class="error remove-error" for="tex"></label>
                    </div>
                    ...
                    <div class="col-sm-12 fv-plugins-icon-container">
                        ...
                        <label id="total_earning-error" class="error remove-error" for="total_earning"></label>
                    </div>
                    ...
                    <div class="col-sm-12 fv-plugins-icon-container">
                        <div class="input-group input-group-merge">
                            ...
                            <div class="form-floating form-floating-outline">
                                <select name="payment" id="" class="form-control employee-id">
                    ...
                    <div class="col-sm-12 fv-plugins-icon-container">
                        <div class="input-group input-group-merge">
                            ...
                            <div class="form-floating form-floating-outline">
                                <select name="project_progress" id=""
                                    class="form-control employee-id project_progress">
                        ...
                        <label id="project_progress-error" class="error remove-error" for="project_progress"></label>
                    </div>
                ...
                <form action="{{ route('admin.project.edit') }}" method="post" id="editForm"
                    ...
                    <div class="col-sm-12 fv-plugins-icon-container">
                        <div class="input-group input-group-merge">
                            <span id="basicFullname2" class="input-group-text"><i class="ri-percent-line"></i></i></span>
                            <div class="form-floating form-floating-outline">
                                <input type="number" class="form-control commission" placeholder="Enter Commission (%)"
                                    name="commission" id="commission" />
                                <label for="basicFullname">Commission (%)</label>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-12 fv-plugins-icon-container">
                        <div class="input-group input-group-merge">
                            <span id="basicFullname2" class="input-group-text"><i class="ri-percent-line"></i></span>
                            <div class="form-floating form-floating-outline">
                                <input type="number" class="form-control tex" placeholder="Enter Tax (%)"
                                    name="tax" id="tex" />
                                <label for="basicFullname">Tax (%)</label>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-12 fv-plugins-icon-container">
                        <div class="input-group input-group-merge">
                            <span id="basicFullname2" class="input-group-text"><i class="ri-bank-card-line"></i></span>
                            <div class="form-floating form-floating-outline">
                                <select name="payment" id="payment" class="form-control employee-id">
                                    <option value="">Select Payment</option>
                                    <option value="1">Milestone</option>
                                    <option value="2">Fix</option>
                                    <option value="3">Hourly</option>
                        ...
                        <div class="input-group input-group-merge">
                            ...
                            <div class="form-floating form-floating-outline">
                                <select name="project_progress" id="project_progress"
                                    class="form-control employee-id project_progress_edit">
                                    <option value="">Select Project Progress</option>
                                    <option value="0">Pendding</option>
                                    <option value="1">Working</option>
                                    <option value="2">Stack</option>
        ...
        <div class="offcanvas offcanvas-end" id="deletemodal" aria-modal="true" role="dialog">
            ...
            <div class="offcanvas-body flex-grow-1">
                ...
                <div class="col-sm-12">
                    <button type="submit" id="deleteProject" class="btn btn-danger waves-effect waves-light"
            ...
            <div class="offcanvas-body flex-grow-1">
                <form action="{{ route('admin.project.payment') }}" method="post" id="paymnetForm"
                    ...
                    <div class="col-sm-12 fv-plugins-icon-container">
                        ...
                        <label id="payment_date-error" class="error remove-error" for="payment_date"></label>
                    </div>
                    ...
                    <div class="col-sm-12 fv-plugins-icon-container">
                        ...
                        <label id="total_payment-error" class="error remove-error" for="total_payment"></label>
                    </div>
            ...
            $(document).ready(function() {
                ...
                $(document).on('click', '.payment', function(event) {
                    ...
                    $('#paymnetForm').validate({
                        ...
                        errorPlacement: function(error, element) {
                            if (element.hasClass('project_progress_edit')) {
                                error.insertAfter(
                                    element);
                            } else {
                                error.insertAfter(
