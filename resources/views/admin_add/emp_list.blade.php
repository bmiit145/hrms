                    ...
                    <div class="card-header flex-column flex-md-row">
                        ...
                        <div class="dt-action-buttons text-end pt-3 pt-md-0">
                            <div class="dt-buttons btn-group flex-wrap">
                                <div class="dt-buttons btn-group flex-wrap">
                                    <button style="background: #7e4ee6;color: #f0f8ff;"
                                        class="btn create-new waves-effect waves-light employee add_recode" tabindex="0"
                    ...
                    $.ajax({
                        ...
                        success: function() {
                            ...
                            var downloadBtn = $('<a>').attr('href', profileFilePath)
                                ...
                                .css('margin-top', '5px')
                                .html(
                                '<i class="ri-download-cloud-line"></i>'); // Add the download icon
                            innerContainer.append(
                            downloadBtn); // Append download button to inner container
