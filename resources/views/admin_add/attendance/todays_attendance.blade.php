    ...
    <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="card-header flex-column flex-md-row">
                        ...
                        <div class="dt-action-buttons text-end pt-3 pt-md-0">
                            <div class="dt-buttons btn-group flex-wrap">
                                <a class="add_recode"><button style="background: #7e4ee6;color: #f0f8ff;"
                                        class="btn create-new waves-effect waves-light employee" tabindex="0"
                            ...
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td><a class="edit" href="#" data-id='{{ $item->id }}'
                                            ...
                                            data-today_date='{{ $item->today_date }}' data-notes='{{ $item->notes }}'
                                            data-last_out='{{ $item->last_out }}' data-status='{{ $item->status }}'
        ...
        <div class="offcanvas offcanvas-end" id="todaymodal" aria-modal="true" role="dialog">
            ...
            <div class="offcanvas-body flex-grow-1">
                <form action="{{ route('attendance.store') }}" method="post" id="password" enctype="multipart/form-data"
                    ...
                    <div class="col-sm-12 fv-plugins-icon-container">
                        <div class="input-group input-group-merge">
                            ...
                            <div class="form-floating form-floating-outline">
                                <select class="form-control employee-id" name="emp_id" required>
                    ...
                    <div class="col-sm-12 fv-plugins-icon-container">
                        <div class="input-group input-group-merge">
                            ...
                            <div class="form-floating form-floating-outline">
                                <input type="text" readonly class="form-control dob-picker" name="today_date"
                                    placeholder="Enter Today Date" required>
        ...
        <div class="offcanvas offcanvas-end" id="editmodal" aria-modal="true" role="dialog">
            ...
            <div class="offcanvas-body flex-grow-1">
                <form action="{{ route('attendance.update') }}" method="post" id="password"
                    ...
                    <div class="col-sm-12 fv-plugins-icon-container">
                        <div class="input-group input-group-merge">
                            ...
                            <div class="form-floating form-floating-outline">
                                <select class="form-control employee-id" name="emp_id" id="emp_id" required>
                                    <option value="">Select Employee Name</option>
                                    @foreach ($user as $item)
                                        <option value="{{ $item->id }}">{{ $item->emo_name }}</option>
                                    @endforeach
                    ...
                    <div class="col-sm-12 fv-plugins-icon-container">
                        <div class="input-group input-group-merge">
                            ...
                            <div class="form-floating form-floating-outline">
                                <input type="text" readonly class="form-control dob-picker" name="today_date"
                                    id="today_date" placeholder="Enter Today Date" required>
                                <label for="basicFullname">Today Date</label>
                            </div>
                        </div>
                    </div>
        ...
        <div class="offcanvas offcanvas-end" id="deletemodal" aria-modal="true" role="dialog">
            ...
            <div class="offcanvas-body flex-grow-1">
                ...
                <form action="{{ route('attendance.delete') }}" method="POST" id="delete-form">
                    @csrf
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('.refresh-btn').click(function(event) {
                ...
                var url = "{{ route('admin.today.attendance') }}";
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.edit', function(event) {
                ...
                var formattedToday_date = formatDate(today_date);

                $('#first_in').val(first_in);
                $('#today_date').val(formattedToday_date);
            ...
            $(document).on('click', '.delete', function(event) {
                ...
                var id = $(this).data('id');
                $('#delete-id').val(id);
                const offcanvasEdit = new bootstrap.Offcanvas(document.getElementById('deletemodal'));
                offcanvasEdit.show();
