...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="col-sm-12 fv-plugins-icon-container">
                        <div class="input-group input-group-merge">
                            ...
                            <div class="form-floating form-floating-outline">
                                <input type="text" class="form-control dt-full-name" name="department_name"
                                    placeholder="Enter department name" aria-label="Enter department name"
        ...
        <div class="offcanvas offcanvas-end" id="edit-new-record" aria-modal="true" role="dialog">
            <div class="offcanvas-header border-bottom">
                <h5 class="offcanvas-title" id="editExampleModalLabel">Edit Department</h5>
                <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
            </div>
            <div class="offcanvas-body flex-grow-1">
                <form action="edit_department" method="post" id="password" enctype="multipart/form-data"
                    ...
                    <div class="col-sm-12 fv-plugins-icon-container">
                        <div class="input-group input-group-merge">
                            <span id="basicFullname2" class="input-group-text"><i class="ri-user-line ri-18px"></i></span>
                            <div class="form-floating form-floating-outline">
                                <input type="texr" class="form-control dt-full-name" placeholder="Enter department name"
            ...
            $('#delete-form').on('submit', function(event) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        var offcanvasDelete = bootstrap.Offcanvas.getInstance(document
                            .getElementById('delete-new-record'));
                    ...
                    error: function() {
                        alert(
                            'There was an error while deleting the department. Please try again.');
                    }
                });
            });
        });
