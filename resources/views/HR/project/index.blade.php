    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="offcanvas offcanvas-end" id="deletemodal" aria-modal="true" role="dialog">
            ...
            <div class="offcanvas-body flex-grow-1">
                ...
                <div class="col-sm-12">
                    <button type="submit" id="deleteProject" class="btn  waves-effect waves-light"
                        style="background: linear-gradient(270deg, #b30000 0%, #ff6666 100%) !important; color: #f0f8ff;">Delete</button>
                    <button type="reset" class="btn btn-outline-secondary waves-effect"
                        data-bs-dismiss="offcanvas">Cancel</button>
                </div>
            </div>
