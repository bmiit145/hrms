...
<style>
    ...
    label.error {
      ...
      body.dark-mode select#add_leave_type {
         background-color: #312d4b;
    }
    body.dark-mode  select#edit_leave_type{
         background-color: #312d4b;
    }
                ...
                <div class="card-header flex-column flex-md-row">
                    ...
                    <div class="dt-action-buttons text-end pt-3 pt-md-0">
                        <div class="dt-buttons btn-group flex-wrap">
                            <button style="color: white;" class="btn  create-new waves-effect waves-light employee"
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="details-display">
                                        ...
                                        <span class="details-full" style="display: none;">{{ $item->rejected_reason }}</span>
        ...
        <form id="addForm" class="leaveAdd" enctype="multipart/form-data">
            ...
            <div class="col-sm-12 fv-plugins-icon-container mt-5">
                <div class="input-group input-group-merge">
                    ...
                    <div class="form-floating form-floating-outline">
                        <input type="text" class="form-control dob-picker" name="from_date" id="add_from_date" 
            ...
            <div class="col-sm-12 fv-plugins-icon-container mt-5">
                <div class="input-group input-group-merge">
                    ...
                    <div class="form-floating form-floating-outline">
                        <input type="text" class="form-control dob-picker" name="to_date" id="add_to_date"
                            placeholder="" readonly>
            ...
            <div class="col-sm-12 fv-plugins-icon-container mt-5">
                <div class="input-group input-group-merge">
                    ...
                    <div class="form-floating form-floating-outline">
                        <textarea type="text" class="form-control leave_reason" name="leave_reason" row="15" cols="50" id="add_leave_reason"
                            placeholder="Enter Employee Reason" aria-label="Enter Date" aria-describedby="basicFullname2"></textarea>
                        <label for="add_leave_reason">Reason</label>
                    </div>
                </div>
                <label id="add_leave_reason-error" class="error" for="add_leave_reason"></label>
            </div>
            <button type="submit" class="btn mt-3  waves-effect" style="background: linear-gradient(270deg, #b30000 0%, #ff6666 100%) !important;color: #f0f8ff;">Create</button>
            <button type="reset" class="btn mt-3  waves-effect" data-bs-dismiss="offcanvas" style="background: linear-gradient(270deg, #b30000 0%, #ff6666 100%) !important;color: #f0f8ff;">Cancel</button>
        </form>
    </div>
</div>
        ...
        <form id="editForm" method="POST" enctype="multipart/form-data" class="leaveEdit">
            ...
            <div class="col-sm-12 fv-plugins-icon-container">
                <div class="input-group input-group-merge">
                    <span class="input-group-text"><i class="ri-building-line ri-18px"></i></span>
                    <div class="form-floating form-floating-outline">
                        <select class="form-control leave_type" name="leave_type" id="edit_leave_type">
                            <option value="">Select Leave Type</option>
                            @foreach ($leave as $item)
                                <option value="{{ $item->id }}">{{ $item->leave_type }}</option>
                            @endforeach
            ...
            <div class="col-sm-12 fv-plugins-icon-container mt-5">
                <div class="input-group input-group-merge">
                    <span id="basicFullname1" class="input-group-text"><i class="ri-calendar-2-line"></i></span>
                    <div class="form-floating form-floating-outline">
                        <input type="text" class="form-control dob-picker" name="from_date" id="edit_from_date"
                            placeholder="" readonly>
            ...
            <div class="col-sm-12 fv-plugins-icon-container mt-5">
                <div class="input-group input-group-merge">
                    <span id="basicFullname2" class="input-group-text"><i class="ri-calendar-2-line"></i></span>
                    <div class="form-floating form-floating-outline">
                        <input type="text" class="form-control dob-picker" name="to_date" id="edit_to_date"
                            placeholder="" readonly>
...
<div class="offcanvas offcanvas-end" id="delete-new-record" aria-modal="true" role="dialog">
    ...
    <div class="offcanvas-body flex-grow-1">
        ...
        <form action="{{ route('hr.delete_leave_request_user') }}" method="POST" id="delete-form">
            @csrf
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        $('.leaveAdd').validate({
            ...
            errorPlacement: function(error, element) {
                if (element.hasClass('leave_type') || element.hasClass(
                        'leave_reason')) {
                    error.insertAfter(
                        element);
                } else {
            ...
            highlight: function(element, errorClass, validClass) {
                if (!$(element).hasClass('leave_type') && !$(element)
            ...
            submitHandler: function (form) {
                ...
                $.ajax({
                    url: "{{ route('hr.leave_request_store') }}",
                    type: "POST",
                    data: formData,
                    processData: false,
                    contentType: false,
        ...
        $('.leaveEdit').validate({
            ...
            submitHandler: function (form) {
                ...
                $.ajax({
                    url: "{{ route('hr.edit_leave_request') }}",
                    type: "POST",
                    data: formData,
                    processData: false,
                    contentType: false,
...
<script>
    $(document).ready(function () {
        ...
        $('#confirm-delete-btn').on('click', function () {
            ...
            $.ajax({
                url: "{{ route('hr.delete_leave_request_user') }}",
                type: "POST",
                data: {
