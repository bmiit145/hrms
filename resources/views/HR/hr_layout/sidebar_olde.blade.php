                    ...
                    <li class="menu-item active open">
                        ...
                        <li class="menu-item">
                            <a href="{{route('hr.upcoming_festival')}}" class="menu-link">
                                <i class="menu-icon  tf-icons fa fa-star-o"></i>
                        ...
                        <li class="menu-item">
                            ...
                            <ul class="menu-sub">
                                ...
                                <li class="menu-item">
                                    <a href="{{route('hr.today_attendance')}}" class="menu-link">
                        ...
                        <li class="menu-item">
                            ...
                            <ul class="menu-sub">
                                <li class="menu-item">
                                    <a href="{{route('hr.leave.index')}}" class="menu-link">
                        ...
                        <ul class="navbar-nav flex-row align-items-center ms-auto">
                            ...
                            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="{{route('hr.profile.edit',Auth::user()->id)}}">
