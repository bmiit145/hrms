    ...
    <body>
            ...
            <div class="row mx-0">
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 mt-md-0 mt-sm-4 mt-4">
                    <div class=" p-xl-2 p-lg-2 p-md-2 p-sm-2 p-2" style="height: auto;background: black !important;">
                        ...
                        <form method="GET" action="{{ route('hr.index.benefits') }}">
        ...
        <div class="offcanvas offcanvas-end" id="add-new-record" aria-modal="true" role="dialog">
            ...
            <div class="offcanvas-body flex-grow-1">
                <form action="{{ route('hr.store.benefits') }}" method="post" id="password"
                        ...
                        <div class="input-group input-group-merge">
                            ...
                            <div class="form-floating form-floating-outline">
                                <input type="text" class="form-control dt-full-name  dob-picker " name="date"
                                    ...
                                    aria-describedby="basicFullname2" required readonly>
        ...
        <div class="offcanvas offcanvas-end" id="edit-new-record" aria-modal="true" role="dialog">
            ...
            <div class="offcanvas-body flex-grow-1">
                <form action="{{ route('hr.edit.benefits') }}" method="post" id="password" enctype="multipart/form-data"
                    class="add-new-record pt-0 row g-3 fv-plugins-bootstrap5 fv-plugins-framework">
                    @csrf
        ...
        <div class="offcanvas offcanvas-end" id="deletemodal" aria-modal="true" role="dialog">
            ...
            <div class="offcanvas-body flex-grow-1">
                ...
                <form action="{{ Route('hr.delete.benefits') }}" method="POST" id="delete-form">
                    @csrf
                    <input type="hidden" name="id" id="delete-id">
                    <div class="col-sm-12">
                        <button type="submit" class="btn waves-effect waves-light"
                            style="background: linear-gradient(270deg, #b30000 0%, #ff6666 100%) !important;color:white">Delete</button>
                        <button type="reset" class="btn btn-outline-secondary waves-effect"
                            data-bs-dismiss="offcanvas">Cancel</button>
                    </div>
                </form>
...
<script>
    $(document).ready(function() {
        ...
        $(document).on('click', '.refresh-btn', function(event) {
            event.preventDefault();
            window.location.href = "{{ route('hr.index.benefits') }}";
        });
