                    ...
                    <div class="info-container">
                        <ul class="list-unstyled mb-6">
                            ...
                            <li class="mb-2">
                                ...
                                <span>{{ $data->emp_birthday_date ?? '' }}</span>
                            </li>
                            <li class="mb-2">
        ...
        <div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
            ...
            <div class="nav-align-top">
                <ul class="nav nav-pills flex-column flex-md-row flex-wrap mb-6 row-gap-2">
                    ...
                    <li class="nav-item">
                        <a class="nav-link waves-effect waves-light tablink active" href="javascript:void(0);"
                            onclick="openPage('Security', this, '#8c57ff')">
            ...
            <div class="modal-dialog modal-lg modal-simple modal-edit-user">
                <div class="modal-content">
                    <div class="modal-body p-0">
                        ...
                        <form action="{{route('hr.profile.update')}}" method="post" id="editUserForm"
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-floating form-floating-outline">
                                    <input type="text" class="form-control dob-picker" name="emp_birthday_date"
                                        id="emp_birthday_date" value="{{ $data->emp_birthday_date ? \Carbon\Carbon::parse($data->emp_birthday_date)->format('d-m-Y') : '' }}"
                                        placeholder="Select Birthday Date" readonly>
                            ...
                            <div class="col-12 col-md-12">
                                <div class="form-floating form-floating-outline">
                                    <textarea name="address" class="form-control" style="height: 102px;"
                            ...
                            <div class="col-12 col-md-12">
                                ...
                                <div class="mt-2" style="position: relative;">
                                    @if(isset($data) && !empty($data->profile_image) && file_exists(public_path('profile_image/' . $data->profile_image)))
                                        ...
                                        <div class="icon-container" style="position: absolute;top:-11px;left:115px;">
