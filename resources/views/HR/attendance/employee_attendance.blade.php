            ...
            <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                ...
                <form method="GET" action="{{ route('hr.employee_attendance') }}">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <button type="submit" class="btn  mt-5" style="background: linear-gradient(270deg, #b30000 0%, #ff6666 100%) !important;color: #fff;">Submit</button>
                            <button type="submit" class="btn  mt-5 refresh-btn" style="background: linear-gradient(270deg, #b30000 0%, #ff6666 100%) !important;"><i class="ri-refresh-line ri-22px text-white"></i></button>
                        </div>
                    </div>
                </form>
                <hr class="my-0 mt-3">
                    ...
                    <tbody>
                        ...
                        <td>
                           ...
                           <td>
                               ...
                               <td>
                                   <a href="{{ url('hr/salary_priview/' . $attendances->first()->get_emp_name->id . '/' . $month . '/' . $year) }}" target="_blank">
