...
<div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="card-header flex-column flex-md-row">
                    ...
                    <div class="dt-action-buttons text-end pt-3 pt-md-0">
                        <div class="dt-buttons btn-group flex-wrap">
                            <div class="dt-buttons btn-group flex-wrap">
                                <button style="background: #7e4ee6;color: #f0f8ff;" class="btn  create-new  waves-effect waves-light employee add_recode" tabindex="0" aria-controls="DataTables_Table_0" type="button"><span><i class="ri-add-line"></i> <span class="d-none d-sm-inline-block">Add New
                                            Employee</span></span>
                                </button>
                            </div>
                        </div>
                ...
                <table class="datatables-basic table table-bordered dataTable no-footer dtr-column" id="example" aria-describedby="DataTables_Table_0_info" style="width: 1395px;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $item->email }}</td>
                            <td>{{ optional($item->joining_date) ? \Carbon\Carbon::parse($item->joining_date)->format('d-m-y') : '' }}
                            </td>
                            <td>
                                <a class="edit" href="#" data-id='{{ $item->id }}' data-emp_name='{{ $item->emo_name }}' data-emp_email='{{ $item->email }}' data-emp_mobile_no='{{ $item->emp_mobile_no }}' data-emp_address='{{ $item->emp_address }}' data-emp_father_mobile_no='{{ $item->emp_father_mobile_no }}' data-emp_mother_mobile_no='{{ $item->emp_mother_mobile_no }}' data-emp_brother_sister_mobile_no='{{ $item->emp_brother_sister_mobile_no }}' data-bank_name='{{ $item->bank_name }}' data-bank_no='{{ $item->bank_no }}' data-emp_department_name='{{ $item->emp_department_name }}' data-joining_date='{{ $item->joining_date }}' data-emp_document='{{ $item->emp_document }}' data-emp_bank_document='{{ $item->emp_bank_document }}' data-emp_birthday_date='{{ $item->emp_birthday_date }}' data-monthly_selery='{{ $item->monthly_selery }}' data-emp_notes='{{ $item->emp_notes }}' data-profile_image='{{ $item->profile_image }}' data-role='{{ $item->role }}' data-emp_team_head_id='{{ $item->emp_team_head_id }}'>
                                ...
                                <a href="{{ route('hr.employee_view', $item->id) }}" class="view">
    ...
    <div class="offcanvas offcanvas-end" id="addEmployee" aria-modal="true" role="dialog">
        ...
        <div class="offcanvas-body flex-grow-1">
            <form action="{{ route('admin.employee.store') }}" method="post" id="admin_form_store" enctype="multipart/form-data" class="add-new-record pt-0 row g-3 fv-plugins-bootstrap5 fv-plugins-framework myForm">
                @csrf
                <!-- Full Name -->
                <div class="col-sm-12 fv-plugins-icon-container">
                    <div class="input-group input-group-merge">
                        ...
                        <div class="form-floating form-floating-outline">
                            <input type="text" name="add_emp_name" class="form-control" id="add_emp_name" placeholder="Enter Employee Name">
                ...
                <div class="col-sm-12 fv-plugins-icon-container mt-5">
                    <div class="input-group input-group-merge">
                        <span id="basicFullname2" class="input-group-text"><i class="ri-mail-line ri-18px"></i></span>
                        <div class="form-floating form-floating-outline">
                            <input type="email" class="form-control" name="add_emp_email" id="add_emp_email" placeholder="Enter Employee Email">
                ...
                <div class="col-sm-12 fv-plugins-icon-container mt-5">
                    <div class="input-group input-group-merge">
                        ...
                        <div class="form-floating form-floating-outline">
                            <input type="tel" class="form-control" name="add_emp_mobile_no[main]" id="add_emp_mobile_no" placeholder="Enter Employee Mobile Number" oninput="this.value = this.value.replace(/\D+/g, '')">
                ...
                <div class="col-sm-12 fv-plugins-icon-container mt-5">
                    <div class="input-group input-group-merge">
                        <span id="basicFullname2" class="input-group-text"><i class="ri-map-pin-line ri-18px"></i></span>
                        <div class="form-floating form-floating-outline">
                            <input type="text" class="form-control" name="add_emp_address" id="add_emp_address" placeholder="Enter Employee Address">
                ...
                <div class="col-sm-12 fv-plugins-icon-container mt-5">
                    <div class="input-group input-group-merge">
                        <span id="basicFullname2" class="input-group-text"><i class="ri-phone-line ri-18px"></i></span>
                        <div class="form-floating form-floating-outline">
                            <input type="tel" class="form-control mobile" name="emp_father_mobile_no" placeholder="Enter Employee Father Mobile Number" oninput="this.value = this.value.replace(/\D+/g, '')">
                            <label for="basicFullname">Father Mobile Number </label>
                        </div>
                    </div>
                    <label id="emp_father_mobile_no-error" class="error remove-error" for="emp_father_mobile_no"> </label>
                </div>
                <div class="col-sm-12 fv-plugins-icon-container mt-5">
                    <div class="input-group input-group-merge">
                        <span id="basicFullname2" class="input-group-text"><i class="ri-phone-line ri-18px"></i></span>
                        <div class="form-floating form-floating-outline">
                            <input type="tel" class="form-control mobile" name="emp_mother_mobile_no" placeholder="Enter Employee Mother Mobile Number" oninput="this.value = this.value.replace(/\D+/g, '')">
                            <label for="basicFullname">Mother Mobile Number </label>
                        </div>
                    </div>
                    <label id="emp_mother_mobile_no-error" class="error remove-error" for="emp_mother_mobile_no"> </label>
                </div>
                <div class="col-sm-12 fv-plugins-icon-container mt-5">
                    <div class="input-group input-group-merge">
                        <span id="basicFullname2" class="input-group-text"><i class="ri-phone-line ri-18px"></i></span>
                        <div class="form-floating form-floating-outline">
                            <input type="tel" class="form-control mobile" name="emp_brother_sister_mobile_no" placeholder="Enter Employee Brother / Sister Mobile Number" oninput="this.value = this.value.replace(/\D+/g, '')">
                            <label for="basicFullname">Brother / Sister Mobile Number </label>
                        </div>
                    </div>
                    <label id="emp_brother_sister_mobile_no-error" class="error remove-error" for="emp_brother_sister_mobile_no">
                    </label>
                </div>
                <div class="col-sm-12 fv-plugins-icon-container mt-5">
                    <div class="input-group input-group-merge">
                        <span id="basicFullname2" class="input-group-text"><i class="ri-bank-line ri-18px"></i></span>
                        <div class="form-floating form-floating-outline">
                            <input type="tel" class="form-control mobile" name="bank_no" placeholder="Enter Bank Number " oninput="this.value = this.value.replace(/\D+/g, '')">
                ...
                <div class="col-sm-12 fv-plugins-icon-container mt-5">
                    <div class="input-group input-group-merge">
                        <span id="basicFullname2" class="input-group-text"><i class="ri-building-line ri-18px"></i></span>
                        <div class="form-floating form-floating-outline">
                            <select class="form-control add_emp_department_name" name="add_emp_department_name" id="add_emp_department_name" style="color:#6D6777;">
                    ...
                    <label id="add_emp_department_name-error" class="error remove-error" for="add_emp_department_name"></label>
                </div>

                <!-- Joining Date -->
                <div class="col-sm-12 fv-plugins-icon-container mt-5">
                    <div class="input-group input-group-merge">
                        <span id="basicFullname2" class="input-group-text"><i class="ri-calendar-schedule-line ri-18px"></i></span>
                        <div class="form-floating form-floating-outline">
                            <input type="text" readonly class="form-control dob-picker" name="add_joining_date" id="add_joining_date" placeholder="">
                ...
                <div class="col-sm-12 fv-plugins-icon-container mt-5">
                    <div class="input-group input-group-merge">
                        <span id="basicFullname2" class="input-group-text"><i class="ri-money-rupee-circle-line ri-18px"></i></span>
                        <div class="form-floating form-floating-outline">
                            <input type="tel" class="form-control mobile" name="add_monthly_selery" placeholder="Enter Monthly Salary" id="add_monthly_selery" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/^(\d+(\.\)?).*$/, '$1')">
                            <label for="basicFullname">Monthly Salary</label>
                        </div>
                    </div>
                    <label id="add_monthly_selery-error" class="error remove-error" for="add_monthly_selery"> </label>
                </div>
                ...
                <div class="col-sm-12 fv-plugins-icon-container mt-5">
                    <div class="input-group input-group-merge">
                        ...
                        <div class="form-floating form-floating-outline">
                            <input type="file" class="form-control" name="add_emp_document[]" id="add_emp_document" placeholder="" multiple>
                ...
                <div class="col-sm-12 fv-plugins-icon-container mt-5">
                    <div class="input-group input-group-merge">
                        <span id="basicFullname2" class="input-group-text"> <i class="ri-file-line"></i></span>
                        <div class="form-floating form-floating-outline">
                            <input type="file" class="form-control" name="add_emp_bank_document" id="add_emp_bank_document" placeholder="">
                            <label for="basicFullname">Uplode Employee Bank Document</label>
                        </div>
                    </div>
                    <label id="add_emp_bank_document-error" class="error remove-error" for="add_emp_bank_document"></label>
                </div>
                ...
                <div class="col-sm-12 fv-plugins-icon-container mt-5">
                    <div class="input-group input-group-merge">
                        ...
                        <div class="form-floating form-floating-outline">
                            <input type="text" readonly class="form-control dob-picker" name="add_emp_birthday_date" id="add_emp_birthday_date" placeholder="Enter Employee Birthday Date">
                            <label for="basicFullname">Birthday Date</label>
                        </div>
                    </div>
                    <label id="add_emp_birthday_date-error" class="error remove-error" for="add_emp_birthday_date"></label>
                </div>
                <!-- emp_bank_document Employee -->
                <div class="col-sm-12 fv-plugins-icon-container mt-5">
                    <div class="input-group input-group-merge">
                        <span id="basicFullname2" class="input-group-text"><i class="ri-sticky-note-add-line"></i></span>
                        <div class="form-floating form-floating-outline">
                            <input type="text" class="form-control" name="add_Notes" id="Notes" placeholder="">
                ...
                <div class="col-sm-12 fv-plugins-icon-container mt-5">
                    <div class="input-group input-group-merge">
                        <span id="basicFullname2" class="input-group-text"> <i class="ri-lock-line ri-18px"></i></span>
                        <div class="form-floating form-floating-outline">
                            <input type="password" class="form-control" name="add_emp_password" id="add_emp_password" placeholder="············">
                ...
                <div class="col-sm-12 fv-plugins-icon-container mt-5">
                    <div class="input-group input-group-merge">
                        <span id="basicFullname2" class="input-group-text"> <i class="ri-lock-line ri-18px"></i></span>
                        <div class="form-floating form-floating-outline">
                            <input type="password" class="form-control" name="add_confirmed_emp_password" id="add_confirmed_emp_password" placeholder="············">
                            <label for="basicFullname">Confirm Password</label>
                        </div>
                    </div>
                    <label id="add_confirmed_emp_password-error" class="error remove-error" for="add_confirmed_emp_password" style=""></label>
                </div>
                <!-- emp_bank_document Employee -->
                <div class="col-sm-12 fv-plugins-icon-container mt-5">
                    <div class="input-group input-group-merge">
                        <span id="basicFullname2" class="input-group-text"> <i class="ri-file-upload-line ri-18px"></i></span>
                        <div class="form-floating form-floating-outline">
                            <input type="file" class="form-control" name="add_profile_image" id="add_profile_images" placeholder="············">
                ...
                <div class="col-sm-12 fv-plugins-icon-container mt-5">
                    <div class="input-group input-group-merge">
                        <span id="basicFullname2" class="input-group-text"> <i class="ri-user-settings-line ri-18px"></i></span>
                        <div class="form-floating form-floating-outline">
                            <select class="form-control add-role" name="add_role" id="add_role" style="color:#a0acb7">
                ...
                <div class="col-sm-12 fv-plugins-icon-container mt-5">
                    <div class="input-group input-group-merge">
                        <span id="basicFullname2" class="input-group-text"> <i class="ri-user-settings-line ri-18px"></i></span>
                        <div class="form-floating form-floating-outline">
                            <select class="form-control " name="add_emp_team_head_id" id="add_emp_team_head_id" style="color:#a0acb7;">
                ...
                <!-- Buttons -->
                <div class="col-sm-12">
                    <button type="submit" class="btn  data-submit me-sm-4 me-1 waves-effect waves-light" style="background: linear-gradient(270deg, #b30000 0%, #ff6666 100%) !important;color: #fff;">Save</button>
    ...
    <div class="offcanvas offcanvas-end" id="editEmployee" aria-modal="true" role="dialog">
        ...
        <div class="offcanvas-body flex-grow-1">
            <form action="" method="post" id="inquiry_form" enctype="multipart/form-data" class="add-new-record pt-0 row g-3 fv-plugins-bootstrap5 fv-plugins-framework myForm">
                @csrf
                ...
                <div class="col-sm-12 fv-plugins-icon-container mt-5">
                    <div class="input-group input-group-merge">
                        ...
                        <div class="form-floating form-floating-outline">
                            <input type="email" class="form-control emp_email" name="emp_email" id="emp_email" placeholder="Enter Employee Email">
                            <label for="basicFullname">Email </label>
                        </div>
                    </div>
                ...
                <div class="col-sm-12 fv-plugins-icon-container mt-5">
                    <div class="input-group input-group-merge">
                        ...
                        <div class="form-floating form-floating-outline">
                            <input type="tel" class="form-control mobile" name="emp_mobile_no[main]" id="emp_mobile_no" placeholder="Enter Employee Mobile no" oninput="this.value = this.value.replace(/\D+/g, '')">
                            <label for="basicFullname">Mobile Number </label>
                        </div>
                    </div>
                ...
                <div class="col-sm-12 fv-plugins-icon-container mt-5">
                    <div class="input-group input-group-merge">
                        <span id="basicFullname2" class="input-group-text"><i class="ri-map-pin-line ri-18px"></i></span>
                        <div class="form-floating form-floating-outline">
                            <input type="text" class="form-control" name="emp_address" id="emp_address" placeholder="Enter Employee Address">
                            <label for="basicFullname">Address </label>
                        </div>
                    </div>
                ...
                <div class="col-sm-12 fv-plugins-icon-container mt-5">
                    <div class="input-group input-group-merge">
                        <span id="basicFullname2" class="input-group-text"><i class="ri-phone-line ri-18px"></i></span>
                        <div class="form-floating form-floating-outline">
                            <input type="tel" class="form-control mobile" name="emp_father_mobile_no" id="emp_father_mobile_no" placeholder="Enter Employee Father Mobile Number" oninput="this.value = this.value.replace(/\D+/g, '')">
                            <label for="basicFullname">Father Mobile Number </label>
                        </div>
                    </div>
                    <label id="emp_father_mobile_no-error" class="error remove-error" for="emp_father_mobile_no"> </label>
                ...
                <div class="col-sm-12 fv-plugins-icon-container mt-5">
                    <div class="input-group input-group-merge">
                        <span id="basicFullname2" class="input-group-text"><i class="ri-phone-line ri-18px"></i></span>
                        <div class="form-floating form-floating-outline">
                            <input type="tel" class="form-control mobile" name="emp_mother_mobile_no" id="emp_mother_mobile_no" placeholder="Enter Employee Mother Mobile Number" oninput="this.value = this.value.replace(/\D+/g, '')">
                            <label for="basicFullname">Mother Mobile Number </label>
                        </div>
                    </div>
                    <label id="emp_mother_mobile_no-error" class="error remove-error" for="emp_mother_mobile_no"> </label>
                ...
                <div class="col-sm-12 fv-plugins-icon-container mt-5">
                    <div class="input-group input-group-merge">
                        <span id="basicFullname2" class="input-group-text"><i class="ri-phone-line ri-18px"></i></span>
                        <div class="form-floating form-floating-outline">
                            <input type="tel" class="form-control mobile" name="emp_brother_sister_mobile_no" id="emp_brother_sister_mobile_no" placeholder="Enter Employee Brother / Sister Mobile Number" oninput="this.value = this.value.replace(/\D+/g, '')">
                            <label for="basicFullname">Brother / Sister Mobile Number </label>
                        </div>
                    </div>
                    <label id="emp_brother_sister_mobile_no-error" class="error remove-error" for="emp_brother_sister_mobile_no">
                ...
                <div class="col-sm-12 fv-plugins-icon-container mt-5">
                    <div class="input-group input-group-merge">
                        <span id="basicFullname2" class="input-group-text"><i class="ri-bank-line ri-18px"></i></span>
                        <div class="form-floating form-floating-outline">
                            <input type="tel" class="form-control mobile" name="bank_no" placeholder="Enter Bank Number " id="bank_no" oninput="this.value = this.value.replace(/\D+/g, '')">
                            <label for="basicFullname">Bank Number </label>
                        </div>
                    </div>
                    <label id="bank_no-error" class="error remove-error" for="bank_no"> </label>
                ...
                <div class="col-sm-12 fv-plugins-icon-container mt-5">
                    <div class="input-group input-group-merge">
                        ...
                        <div class="form-floating form-floating-outline">
                            <select class="form-control add_emp_department_name" name="emp_department_name" id="emp_department_name">
                                <option value="">Select Department Name</option>
                                @foreach ($department_name as $item)
                    ...
                    <label id="emp_department_name-error" class="error remove-error" for="emp_department_name"></label>
                </div>
                <div class="col-sm-12 fv-plugins-icon-container mt-5">
                    <div class="input-group input-group-merge">
                        <span id="basicFullname2" class="input-group-text"><i class="ri-calendar-2-line"></i></span>
                        <div class="form-floating form-floating-outline">
                            <input type="text" readonly class="form-control dob-picker" name="joining_date" id="joining_date" placeholder="">
                            <label for="basicFullname">Joining Date </label>
                        </div>
                    </div>
                ...
                <div class="col-sm-12 fv-plugins-icon-container mt-5">
                    <div class="input-group input-group-merge">
                        <span id="basicFullname2" class="input-group-text"><i class="ri-money-rupee-circle-line ri-18px"></i></span>
                        <div class="form-floating form-floating-outline">
                            <input type="tel" class="form-control mobile" name="monthly_selery" id="monthly_selery" placeholder="Enter Employee Monthly Salary" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/^(\d+(\.\)?).*$/, '$1')">
                            <label for="basicFullname">Monthly Salary</label>
                        </div>
                    </div>
                ...
                <div class="col-sm-12 fv-plugins-icon-container mt-5">
                    ...
                    <div class="mt-3" style="cursor: pointer;" id="emp_document_preview"></div>
                </div>
                <div class="col-sm-12 fv-plugins-icon-container mt-5">
                    <div class="input-group input-group-merge">
                        <span id="basicFullname2" class="input-group-text"><i class="ri-file-line"></i></i></span>
                ...
                <div class="col-sm-12 fv-plugins-icon-container mt-5">
                    <div class="input-group input-group-merge">
                        <span id="basicFullname2" class="input-group-text"><i class="ri-calendar-2-line"></i></span>
                        <div class="form-floating form-floating-outline">
                            <input type="text" readonly class="form-control dob-picker" name="emp_birthday_date" id="emp_birthday_date" placeholder="Enter Employee Birthday Date">
                            <label for="basicFullname">Birthday Date </label>
                        </div>
                    </div>
                ...
                <div class="col-sm-12 fv-plugins-icon-container mt-5">
                    <div class="input-group input-group-merge">
                        <span id="basicFullname2" class="input-group-text"><i class="ri-sticky-note-add-line"></i></i></span>
                        <div class="form-floating form-floating-outline">
                            <input type="text" class="form-control" name="notes" id="notes" placeholder="Enter Employee Notes">
                            <label for="basicFullname">Notes </label>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-12 fv-plugins-icon-container mt-5">
                    <div class="input-group input-group-merge">
                        ...
                        <div class="form-floating form-floating-outline">
                            <select class="form-control add-role" name="role" id="role" style="color:#a0acb7">
                                <option value="">Select Role</option>
                                <option value="0">Admin</option>
                                <option value="1">Team Head</option>
                                <option value="2">Employee</option>
                ...
                <div class="col-sm-12">
                    <button type="submit" class="btn  data-submit me-sm-4 me-1 waves-effect waves-light" style="background: linear-gradient(270deg, #b30000 0%, #ff6666 100%) !important;color: #fff;">Update</button>
    ...
    <div class="offcanvas offcanvas-end" id="deletemodal" aria-modal="true" role="dialog">
        ...
        <div class="offcanvas-body flex-grow-1">
            ...
            <div class="col-sm-12">
                <button type="submit" id="deletemember" class="btn  waves-effect waves-light" style="background: linear-gradient(270deg, #b30000 0%, #ff6666 100%) !important;color:white">Delete</button>
                <button type="reset" class="btn btn-outline-secondary waves-effect" style=" background: linear-gradient(270deg, #b30000 0%, #ff6666 100%) !important;color: #f0f8ff;" data-bs-dismiss="offcanvas">Cancel</button>
            </div>
        </div>
    </div>
    ...
    <div class="offcanvas offcanvas-end" id="passwordeditmodal" aria-modal="true" role="dialog">
        ...
        <div class="offcanvas-body flex-grow-1">
            <form action="bcdhygubjh" method="post" id="passwordForm" enctype="multipart/form-data" class="add-new-record pt-0 row g-3 fv-plugins-bootstrap5 fv-plugins-framework">
                @csrf
                ...
                <div class="col-sm-12 fv-plugins-icon-container">
                    <div class="input-group input-group-merge">
                        <span id="basicFullname2" class="input-group-text"><i class="ri-user-line ri-18px"></i></span>
                        <div class="form-floating form-floating-outline">
                            <input type="password" class="form-control dt-full-name" name="emp_password" id="emp_password" placeholder="Enter password" aria-describedby="basic-default-password2" required />
                            <label for="basicFullname">Password</label>
                        </div>
                    </div>
                ...
                <div class="col-sm-12 fv-plugins-icon-container mt-5">
                    <div class="input-group input-group-merge">
                        <span id="basicFullname2" class="input-group-text"><i class="ri-user-line ri-18px"></i></span>
                        <div class="form-floating form-floating-outline">
                            <input type="password" class="form-control dt-full-name" name="confirm_password" id="confirm_password" placeholder="Enter confirm password" aria-describedby="basic-default-password2" required />
                            <label for="basicFullname">Confirm Password </label>
                        </div>
                    </div>
    ...
    <div class="offcanvas offcanvas-end" id="lockemodal" aria-modal="true" role="dialog">
        ...
        <div class="offcanvas-body flex-grow-1">
            ...
            <div class="col-sm-12">
                <button id="lockemember" class="btn  waves-effect waves-light" style="background: linear-gradient(270deg, #b30000 0%, #ff6666 100%) !important;color:white">YES</button>
                <button type="reset" class="btn btn-outline-secondary waves-effect" style=" background: linear-gradient(270deg, #b30000 0%, #ff6666 100%) !important;color: #f0f8ff;" data-bs-dismiss="offcanvas">Cancel</button>
            </div>
        </div>
    </div>
    ...
    <div class="offcanvas offcanvas-end" id="unlockemodal" aria-modal="true" role="dialog">
        ...
        <div class="offcanvas-body flex-grow-1">
            ...
            <div class="col-sm-12">
                <button id="unlockemember" class="btn  waves-effect waves-light" style="background: linear-gradient(270deg, #b30000 0%, #ff6666 100%) !important;color:white">YES</button>
                <button type="reset" class="btn btn-outline-secondary waves-effect" style=" background: linear-gradient(270deg, #b30000 0%, #ff6666 100%) !important;color: #f0f8ff;" data-bs-dismiss="offcanvas">Cancel</button>
            </div>
        </div>
    </div>
            ...
            if (emp_documents) {
                ...
                documents.forEach(function(document) {
                    ...
                    $.ajax({
                        ...
                        , type: 'HEAD'
                        , success: function() {
                            // File exists, proceed to display the document
                            if (['jpg', 'jpeg', 'png', 'gif', 'bmp', 'svg']
                                .includes(fileExt)) {
                                // Display Image
                                var imgElement = $('<img>').attr('src', filePath)
                                    .addClass('img-thumbnail')
                                    .css('max-width', '100px').css('margin-right'
                                        , '10px').addClass('preview-img');
                                $('#emp_document_preview').append(
                                    imgElement); // Append image to preview
                            } else if (fileExt === 'pdf') {
                                // Display PDF Icon
                                var pdfIcon = $('<i>').addClass('ri-file-pdf-line')
                                    .css('font-size', '30px').css('color', 'red')
                                    .addClass('preview-pdf')
                                    .attr('data-pdf-url'
                                        , filePath
                                    ); // Add data attribute for the PDF URL
                                $('#emp_document_preview').append(
                                    pdfIcon); // Append PDF icon to preview
                            }
                            ...
                            $('#emp_document_preview').append(downloadBtn);
                            ...
                            // Append the delete button to the document preview container
                            $('#emp_document_preview').append(deleteBtn);
                ...
                $('#emp_document_preview').show(); // Show preview area
            } else {
                $('#emp_document_preview').empty();
            }
                    ...
                    , success: function() {
                        ...
                        if (bankFileExt) {
                            ...
                            var bankImgElement = $('<img>').attr('src', bankFilePath)
                                .addClass('img-thumbnail')
                                .css('max-width', '100px').css('margin-right', '10px')
                                .addClass('preview-img');
                            $('#emp_bank_document_preview').append(
                                bankImgElement); // Append image to preview
                        }
                        ...
                        $('#emp_bank_document_preview').append(
                            downloadBtn); // Append download button
                    ...
                    , success: function() {
                        ...
                        if (profileFileExt) {
                            var profileImgElement = $('<img>').attr('src', profileFilePath)
                                ...
                                .addClass('preview-img');
                            $('#profile_image_preview').append(
                                profileImgElement); // Append image to preview
                        }
