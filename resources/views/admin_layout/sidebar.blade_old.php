                    ...
                    <li class="menu-item active open">
                        ...
                        <li class="menu-item">
                            <a href="{{route('admin.holiday')}}" class="menu-link">
                                ...
                                <div data-i18n="Email">Holidays</div>
                            </a>
                        </li>
                        <li class="menu-item">
                            <a href="{{route('admin.festival')}}" class="menu-link">
                                <i class="menu-icon tf-icons bx bx-crown"></i>
                                <div data-i18n="Email">Festival</div>
                            </a>
                        </li>
                        <li class="menu-item">
                            <a href="javascript:void(0);" class="menu-link menu-toggle">
                            ...
                            <ul class="menu-sub">
                                ...
                                <li class="menu-item">
                                    <a href="{{route('admin.today.attendance')}}" class="menu-link">
                                        <div data-i18n="Without menu">Today's Attendance</div>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a href="{{route('admin.employee.attendance')}}" class="menu-link">
                                        <div data-i18n="Without menu">Employee Attendance</div>
                                    </a>
                                </li>
                                <!-- <li class="menu-item">
                                    <a href="{{route('admin.attendance_sheet')}}" class="menu-link">
                            ...
                            <ul class="menu-sub">
                                <li class="menu-item">
                                    <a href="{{route('admin.leave_request_list')}}" class="menu-link">
                                        <div data-i18n="Without menu">All Leave Requests</div>
                                    </a>
                                </li>  
                            </ul>
                        </li>
