        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    <!-- Dashboards -->
                    <li class="menu-item {{ Route::currentRouteName() == 'admin.dahsboard' ? 'active' : '' }}">
                    ...
                    <li
                        class="menu-item {{ Route::currentRouteName() == 'admin.department' || Route::currentRouteName() == 'admin.employee' || Route::currentRouteName() == 'admin.employee_view' ||  Route::currentRouteName() == 'admin.admin.list' ? 'active' : '' }} {{ Route::currentRouteName() == 'admin.department' || Route::currentRouteName() == 'admin.employee' || Route::currentRouteName() == 'admin.employee.create' || Route::currentRouteName() == 'admin.employee.edit' || Route::currentRouteName() == 'admin.employee_view' || Route::currentRouteName() == 'admin.admin.list' ? 'open' : '' }}">
                        ...
                        <ul class="menu-sub">
                            <li
                                class="menu-item {{ Route::currentRouteName() == 'admin.department' ? 'active' : '' }}">
                                <a href="{{ route('admin.department') }}" class="menu-link">
                                    <div>Add Department</div>
                                </a>
                            </li>
                            <li
                                class="menu-item {{ Route::currentRouteName() == 'admin.employee' || Route::currentRouteName() == 'admin.employee.create' || Route::currentRouteName() == 'admin.employee.edit' || Route::currentRouteName() == 'admin.employee_view' ? 'active' : '' }}">
                                <a href="{{ route('admin.employee') }}" class="menu-link">
                                    <div>Add Employee Details</div>
                                </a>
                            </li>
                            <li
                                class="menu-item {{ Route::currentRouteName() == 'admin.admin.list' ? 'active' : '' }}">
                    ...
                    <li class="menu-item {{ Route::currentRouteName() == 'admin.holiday' ? 'active' : '' }}">
                        <a href="{{ route('admin.holiday') }}" class="menu-link">
                            <i class="menu-icon tf-icons ri-sun-line"></i>
                            <div>Holiday</div>
                        </a>
                    </li>

                    <li class="menu-item {{ Route::currentRouteName() == 'admin.festival' ? 'active' : '' }}">
                        <a href="{{ route('admin.festival') }}" class="menu-link">
                    ...
                    <li
                        class="menu-item {{ Route::currentRouteName() == 'admin.today.attendance' || Route::currentRouteName() == 'admin.employee.attendance' || Route::currentRouteName() == 'index.overtime' || Route::currentRouteName() == 'index.benefits' ? 'active' : '' }} {{ Route::currentRouteName() == 'admin.today.attendance' || Route::currentRouteName() == 'admin.employee.attendance' || Route::currentRouteName() == 'index.overtime' || Route::currentRouteName() == 'index.benefits' ? 'open' : '' }}">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                        ...
                        <ul class="menu-sub">
                            <li
                                class="menu-item {{ Route::currentRouteName() == 'admin.today.attendance' ? 'active' : '' }}">
                                <a href="{{ route('admin.today.attendance') }}" class="menu-link">
                                    <div>Today's Attendance</div>
                                </a>
                            </li>
                            <li
                                class="menu-item {{ Route::currentRouteName() == 'admin.employee.attendance' ? 'active' : '' }}">
                                <a href="{{ route('admin.employee.attendance') }}" class="menu-link">
                                    <div>Employee Attendance</div>
                                </a>
                            </li>
                            <li class="menu-item {{ Route::currentRouteName() == 'index.overtime' ? 'active' : '' }}">
                                <a href="{{ route('index.overtime') }}" class="menu-link">
                                    <div>Over Time</div>
                                </a>
                            </li>
                            <li class="menu-item {{ Route::currentRouteName() == 'index.benefits' ? 'active' : '' }}">
                                <a href="{{ route('index.benefits') }}" class="menu-link">
                                    <div>Benefits</div>
                                </a>
                            </li>
                        </ul>
                    ...
                    <li
                        class="menu-item {{ Route::currentRouteName() == 'admin.leave_request_list' ? 'active' : '' }} {{ Route::currentRouteName() == 'admin.leave_request_list' ? 'open' : '' }}">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                        ...
                        <ul class="menu-sub">
                            <li
                                class="menu-item {{ Route::currentRouteName() == 'admin.leave_request_list' ? 'active' : '' }}">
                                <a href="{{ route('admin.leave_request_list') }}" class="menu-link">
                    ...
                    <li
                        class="menu-item {{ Route::currentRouteName() == 'admin.Client_view' ? 'active' : '' }} {{ Route::currentRouteName() == 'admin.Client_view' || Route::currentRouteName() == 'admin.Clinetincome' ? 'open' : '' }}">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                        ...
                        <ul class="menu-sub">
                            <li
                                class="menu-item {{ Route::currentRouteName() == 'admin.Client_view' ? 'active' : '' }}">
                                <a href="{{ route('admin.Client_view') }}" class="menu-link">
                                    <div>Client Data</div>
                                </a>
                            </li>
                        </ul>
                        <ul class="menu-sub">
                            <li
                                class="menu-item {{ Route::currentRouteName() == 'admin.Clinetincome' ? 'active' : '' }}">
                                <a href="{{ route('admin.Clinetincome') }}" class="menu-link">
                    ...
                    <li class="menu-item {{ Route::currentRouteName() == 'admin.project' ? 'active' : '' }}">
                    ...
                    <li
                        class="menu-item 
                        {{ in_array(Route::currentRouteName(), ['admin.invoice.index', 'admin.invoice.create', 'admin.invoice.deleted','admin.invoice.update']) ? 'active' : '' }} 
                        {{ in_array(Route::currentRouteName(), ['admin.invoice.index', 'admin.invoice.create', 'admin.invoice.deleted','admin.invoice.update']) ? 'open' : '' }}">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                            <i class="menu-icon ri-group-line"></i>
                            <div>Invoice</div>
                        </a>
                        <ul class="menu-sub">
                            ...
                            <li
                                class="menu-item {{ in_array(Route::currentRouteName(), ['admin.invoice.index', 'admin.invoice.create','admin.invoice.update']) ? 'active' : '' }}">
                        ...
                        <ul class="menu-sub">
                            <li
                                class="menu-item {{ Route::currentRouteName() == 'admin.invoice.deleted' ? 'active' : '' }}">
                                <a href="{{ route('admin.invoice.deleted') }}" class="menu-link">
                    ...
                    <li class="menu-item {{ Route::currentRouteName() == 'admin.company_progress' ? 'active' : '' }}">
                        <a href="{{ route('admin.company_progress') }}" class="menu-link">
