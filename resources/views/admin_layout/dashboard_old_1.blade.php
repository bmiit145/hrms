      ...
      <div class="card h-100">
        <div class="card-header">
          <div class="d-flex justify-content-between">
            ...
            <div class="dropdown">
              <button class="btn text-muted p-0" type="button" id="totalSalesDropdown" data-bs-toggle="dropdown"
                aria-haspopup="true" aria-expanded="false">
                <i class="ri-more-2-line ri-24px"></i>
              </button>
      ...
      <div class="card h-100">
        <div class="card-header">
          <div class="d-flex justify-content-between">
            ...
            <div class="dropdown">
              <button class="btn text-muted p-0" type="button" id="revenueReportDropdown" data-bs-toggle="dropdown"
                aria-haspopup="true" aria-expanded="false">
                <i class="ri-more-2-line ri-24px"></i>
              </button>
      ...
      <div class="card h-100">
        <div class="card-header">
          <div class="d-flex justify-content-between">
            ...
            <div class="dropdown">
              <button class="btn text-muted p-0" type="button" id="salesOverviewDropdown" data-bs-toggle="dropdown"
                aria-haspopup="true" aria-expanded="false">
                <i class="ri-more-2-line ri-24px"></i>
              </button>
      ...
      <div class="card h-100">
        <div class="card-header">
          <div class="d-flex justify-content-between">
            ...
            <div class="dropdown">
              <button class="btn text-muted p-0" type="button" id="weeklySalesDropdown" data-bs-toggle="dropdown"
                aria-haspopup="true" aria-expanded="false">
                <i class="ri-more-2-line ri-24px"></i>
              </button>
    ...
    <div class="col-xxl-4 col-xl-6 col-lg-8 col-md-6">
      <div class="card h-100">
        <div class="card-header d-flex align-items-center justify-content-between">
          ...
          <div class="dropdown">
            <button class="btn text-muted p-0" type="button" id="upgradePlanCard" data-bs-toggle="dropdown"
              aria-haspopup="true" aria-expanded="false">
              <i class="ri-more-2-line ri-24px"></i>
            </button>
        ...
        <div class="card-body">
          ...
          <form id="paymentDetailsForm" onsubmit="return false">
            ...
            <div class="col-12 text-center">
              <button type="submit" class="btn btn-primary w-100"><span class="me-1">Contact
                  Now</span></button>
            </div>
          </form>
        </div>
    ...
    <div class="col-xxl-4 col-md-6">
      <div class="card h-100">
        <div class="card-header d-flex align-items-center justify-content-between">
          ...
          <div class="dropdown">
            <button class="btn text-muted p-0" type="button" id="meetingSchedule" data-bs-toggle="dropdown"
              aria-haspopup="true" aria-expanded="false">
              <i class="ri-more-2-line ri-24px"></i>
            </button>
        ...
        <div class="card-body">
          <div class="d-flex border-bottom pb-4">
            ...
            <div>
              ...
              <small class="mb-0">The WordPress open source,free software project is the community
                behind the…</small>
            </div>
          </div>
          ...
          <form id="addNewCCForm" class="row g-5" onsubmit="return false">
            ...
            <div class="col-6 col-md-3">
              <div class="input-group input-group-merge">
                ...
                <span class="input-group-text cursor-pointer ps-0" id="modalAddCardCvv2"><i class="ri-question-line"
                    data-bs-toggle="tooltip" data-bs-placement="top" title="Card Verification Value"></i></span>
              </div>
            </div>
            <div class="col-12">
              <div class="form-check form-switch">
                <input type="checkbox" class="form-check-input" id="futureAddress" />
                <label for="futureAddress" class="text-heading">Save card for future
                  billing?</label>
              </div>
            </div>
            <div class="col-12 text-center">
