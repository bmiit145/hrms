                                    ...
                                    <div class="d-flex border rounded position-relative pe-0">
                                        <div class="row w-100 p-5 gx-5">
                                            ...
                                            <div class="col-md-2 col-12 mb-md-0 mb-5">
                                                ...
                                                <input type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1')" id="unit-cost"
                                                    class="form-control invoice-item-price mb-5" placeholder="Cost"
                                                    min="12">
                                            </div>
                                            ...
                                            <div id="hourly-fields" class="col-md-2 col-12 mb-md-0 mb-4"
                                                ...
                                                <input type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1')" id="hours" class="form-control hours"
                                                    placeholder="Enter hours" min="1">
                                            </div>
                                            <div id="fixqty-fields" class="col-md-2 col-12 mb-md-0 mb-4"
                                                style="display: none;">
                                                <h6 class="h6 repeater-title">QTY</h6>
                                                <input type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1')" id="fixqty" class="form-control fixqty"
                                                    placeholder="Enter Qty" min="1">
                                            </div>
                                        ...
                                        <div
                                            ...
                                            <div class="dropdown">
                                                <div class="dropdown-menu dropdown-menu-end w-px-300 p-4"
                                                    ...
                                                    <button type="button"
                                                        class="btn btn-apply-changes waves-effect"
                                                        style="background: linear-gradient(270deg, #b30000 0%, #ff6666 100%) !important;color: #fff;">Apply</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="row justify-content-end">
                        ...
                        {{-- <div class="col-auto">
                            <button type="button" class="btn btn-primary btn-sm waves-effect waves-light"
                                id="invoice-privew" style="background-color: #8c57ff; color: #fff;">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('[data-repeater-create]').on('click', function() {
                ...
                var newItem = $('#new_item .repeater-wrapper').first()
                    .clone(); // Always clone the first repeater-wrapper template
                newItem.find('input, select, textarea').val(''); // Clear all values in the new item
                newItem.find('.error').remove(); // Remove any existing error messages
                ...
                updateItemPrice(newItem); // Initialize the price calculation for the new item
                updateTotalPrice(); // Update total price when new item is added
            });
            ...
            $(document).on('click', '[data-repeater-delete]', function() {
                ...
                const isDefaultItem = currentItem.attr('data-default-item') ===
                    'true'; // Check if it's the default item
        ...
        $('#create-invoice').on('click', function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    window.location.href = "{{ url('user/invoice/preview') }}/" + response
