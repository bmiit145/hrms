                    ...
                    <div class="card-header flex-column flex-md-row">
                        ...
                        <div class="dt-action-buttons text-end pt-3 pt-md-0">
                            <div class="dt-buttons btn-group flex-wrap">
                                <div class="dt-buttons btn-group flex-wrap">
                                    <a href="{{ route('user.invoice.create') }}" class="add_recode"><button
                        ...
                        <tbody>
                            @foreach ($invoices as $key => $invoice)
                                <tr>
                                    ...
                                    <td>{{ $invoice->total }}</td>
                                    <td>
                                        <a class="edit" href="{{ route('user.invoice.update', $invoice->id) }}">
                                            <i class="ri-edit-box-line ri-22px list-btn"></i>
                                        </a>
                                        <a target="_blank" class="view"
                                            href="{{ route('user.invoices.preview', $invoice->id) }}">
