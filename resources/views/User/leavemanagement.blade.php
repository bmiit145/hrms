...
@section('content')
        ...
        <div class="card">
            <div class="card-datatable table-responsive pt-0">
                <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                            ...
                            <div class="dt-buttons btn-group flex-wrap">
                                <button class="btn create-new waves-effect waves-light employee" tabindex="0"
                                    ...
                                    <span>
                                        ...
                                        <span class="d-none d-sm-inline-block text-white">Add New Record</span>
                                    </span>
                                </button>
                            </div>
                        </div>
                        ...
                        <tbody>
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td class="leaveType" style="overflow-x: auto;white-space: nowrap;">{{ $item->leaveType->leave_type ?? 'N/A' }}</td>

                                    <td class="fromDate" style="overflow-x: auto;white-space: nowrap;">{{ \Carbon\Carbon::parse($item->from_date)->format('d-m-y') }}</td>
                                    ...
                                    <td>
                                        <span class="details-display">
                                            ...
                                            <span class="details-full" style="display: none;">{{ $item->leave_reason }}</span>
                                    ...
                                    <td>
                                        <a class="edit list-btn" href="#" data-id='{{ $item->id }}'
                                            ...
                                            <i class="ri-edit-box-line" style="font-size:24px"></i>
                                        </a>
                                        <a href="#" class="delete list-btn " data-id='{{ $item->id }}'>
                                            <i class="ri-delete-bin-6-line" style="font-size:24px"></i>
                                        </a>
                                    </td>
                                </tr>
                            @endforeach
                    ...
                    <button class="dt-button buttons-delete btn buttons-html5 btn-delete" tabindex="0"
                        aria-controls="example" type="button"
                        style="display:none !important; background: linear-gradient(270deg, #b30000 0%, #ff6666 100%) !important;color: #f0f8ff;"
                        id="delete_button">
        ...
        <div class="offcanvas-body">
            <form id="addForm" class="leaveAdd" enctype="multipart/form-data">
                ...
                <div class="col-sm-12 fv-plugins-icon-container mt-5">
                    ...
                    <label id="add_leave_type-error" class="error remove-error" for="add_leave_type"></label>
                </div>
                <div class="col-sm-12 fv-plugins-icon-container" style="margin-top: 30px;">
                    <div class="input-group input-group-merge">
                    ...
                    <label id="add_from_date-error" class="error remove-error" for="add_from_date"></label>
                </div>
                <div class="col-sm-12 fv-plugins-icon-container" style="margin-top: 30px;">
                    <div class="input-group input-group-merge">
                    ...
                    <label id="add_to_date-error" class="error remove-error" for="add_to_date"></label>
                </div>
                <div class="col-sm-12 fv-plugins-icon-container" style="margin-top: 30px;">
                    <div class="input-group input-group-merge">
                    ...
                    <label id="add_leave_reason-error" class="error remove-error" for="add_leave_reason"></label>
                </div>
                <button type="submit" class="btn waves-effect"
                    style="background: linear-gradient(270deg, #b30000 0%, #ff6666 100%) !important;color: #f0f8ff;margin-top: 25px;">Create</button>
                <button type="reset" class="btn btn-outline-secondary waves-effect" style="margin-top: 25px;"
        ...
        <div class="offcanvas-body flex-grow-1">
            <form id="editForm" method="POST" enctype="multipart/form-data" class="leaveEdit">
                ...
                <div class="col-sm-12 fv-plugins-icon-container">
                    ...
                    <label id="edit_leave_type-error" class="error remove-error" for="edit_leave_type"></label>
                </div>
                <div class="col-sm-12 fv-plugins-icon-container" style="margin-top: 30px;">
                    <div class="input-group input-group-merge">
                        <span id="basicFullname1" class="input-group-text"><i class="ri-calendar-2-line"></i></span>
                    ...
                    <label id="edit_from_date-error" class="error remove-error" for="edit_from_date"></label>
                </div>
                <div class="col-sm-12 fv-plugins-icon-container" style="margin-top: 30px;">
                    <div class="input-group input-group-merge">
                        <span id="basicFullname2" class="input-group-text"><i class="ri-calendar-2-line"></i></span>
                    ...
                    <label id="edit_to_date-error" class="error remove-error" for="edit_to_date"></label>
                </div>
                <div class="col-sm-12 fv-plugins-icon-container" style="margin-top: 30px;">
                    <div class="input-group input-group-merge">
                    ...
                    <label id="edit_leave_reason-error" class="error remove-error" for="edit_leave_reason"></label>
                </div>
                <button type="submit" class="btn"
                    style="background: linear-gradient(270deg, #b30000 0%, #ff6666 100%) !important;color: #f0f8ff;margin-top: 25px;">Update</button>
            </form>
        </div>
    </div>
    ...
    <div class="offcanvas offcanvas-end" id="delete-new-record" aria-modal="true" role="dialog">
        ...
        <div class="offcanvas-body flex-grow-1">
            ...
            <form action="{{ route('user.delete_leave_request') }}" method="POST" id="delete-form">
                @csrf
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            $('.leaveAdd').validate({
                ...
                submitHandler: function(form) {
                    ...
                    $.ajax({
                        url: "{{ route('user.leave_request_store') }}",
                        type: "POST",
                        data: formData,
                        processData: false,
                        contentType: false,
            ...
            $('.leaveEdit').validate({
                ...
                submitHandler: function(form) {
                    ...
                    $.ajax({
                        url: "{{ route('user.edit_leave_request') }}",
                        type: "POST",
                        data: formData,
                        processData: false,
                        contentType: false,
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#confirm-delete-btn').on('click', function() {
                ...
                $.ajax({
                    url: "{{ route('user.delete_leave_request') }}",
                    type: "POST",
                    data: {
    ...
    <script>
        $(document).ready(function() {
            ...
            function toggleDeleteButton() {
                ...
                if (selectedCount > 0) {
                    $('#delete_button').attr('style', 'display: block !important;background: linear-gradient(270deg, #b30000 0%, #ff6666 100%) !important;color: #f0f8ff;'); // Show the delete button
                } else {
