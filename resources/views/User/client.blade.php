                        ...
                        <tbody>
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td><a class="payment" data-id="{{ $item->id }}"
                ...
                <form action="{{ route('admin.Client_store') }}" method="post" id="password"
                    ...
                    {{-- <div class="col-sm-12 fv-plugins-icon-container">
                        <div class="input-group input-group-merge">
                            ...
                            <div class="form-floating form-floating-outline">
                                <input type="text" class="form-control dt-full-name" name="currency"
                                    placeholder="Enter currency" aria-label="Enter currency"
                                    aria-describedby="basicFullname2" required>
                    ...
                    {{-- <div class="col-sm-12 fv-plugins-icon-container">
                        <div class="input-group input-group-merge">
                            <span id="basicFullname2" class="input-group-text"><i
                                    class="ri-money-dollar-circle-line ri-18px"></i></span>
                            <div class="form-floating form-floating-outline">
                                <input type="text" class="form-control dt-full-name" name="edit_currency"
                                    id="edit_currency" placeholder="Enter currency" aria-label="Enter currency"
                                    aria-describedby="basicFullname2" required>
                                <label for="basicFullname">Currency</label>
                            </div>
                        </div>
