...
<head>
    ...
    <style>
        ...
        body.dark-mode i.ri-menu-fill.ri-24px {
            color: #d5d1ea;
        }
        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="{{ route('user.dahsboard') }}" class="app-brand-link">
                ...
                <ul class="menu-inner py-1">
                    <!-- Dashboards -->
                    <li class="menu-item {{ Route::currentRouteName() == 'user.dahsboard' ? 'active' : '' }}">
                    ...
                    <li
                        class="menu-item {{ Route::currentRouteName() == 'user.user_attendance_list' || Route::currentRouteName() == 'user.user_attendance_sheet' ? 'active' : '' }} 
                                            {{ Route::currentRouteName() == 'user.user_attendance_list' || Route::currentRouteName() == 'user.user_attendance_sheet' ? 'open' : '' }}">
                        ...
                        <ul class="menu-sub">
                            <li
                                class="menu-item {{ Route::currentRouteName() == 'user.user_attendance_list' ? 'active' : '' }}">
                                <a href="{{ route('user.user_attendance_list') }}" class="menu-link">
                                    <div>Today's Attendance</div>
                                </a>
                            </li>
                            <li
                                class="menu-item {{ Route::currentRouteName() == 'user.user_attendance_sheet' ? 'active' : '' }}">
                    ...
                    <li
                        class="menu-item {{ Route::currentRouteName() == 'user.leave_request_createt' ? 'active' : '' }} 
                                            {{ Route::currentRouteName() == 'user.leave_request_create' ? 'open' : '' }}">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                        ...
                        <ul class="menu-sub">
                            <li
                                class="menu-item {{ Route::currentRouteName() == 'user.leave_request_create' ? 'active' : '' }}">
                    ...
                    @if (optional(Auth::user()->page_role)->client_data == 1 || optional(Auth::user()->page_role)->client_income == 1)
                        <li
                            class="menu-item {{ Route::currentRouteName() == 'user.Client_view' ? 'active' : '' }} {{ Route::currentRouteName() == 'user.Client_view' || Route::currentRouteName() == 'user.Clinetincome' ? 'open' : '' }}">
                            <a href="javascript:void(0);" class="menu-link menu-toggle">
                            ...
                            @if (optional(Auth::user()->page_role)->client_data == 1)
                                <ul class="menu-sub">
                                    <li
                                        class="menu-item {{ Route::currentRouteName() == 'user.Client_view' ? 'active' : '' }}">
                                        <a href="{{ route('user.Client_view') }}" class="menu-link">
                                            <div>Client Data</div>
                                        </a>
                                    </li>
                                </ul>
                            ...
                            @if (optional(Auth::user()->page_role)->client_income == 1)
                                <ul class="menu-sub">
                                    <li
                                        class="menu-item {{ Route::currentRouteName() == 'user.Clinetincome' ? 'active' : '' }}">
                                        <a href="{{ route('user.Clinetincome') }}" class="menu-link">
                    ...
                    @if (optional(Auth::user()->page_role)->project_data == 1)
                        <li class="menu-item {{ Route::currentRouteName() == 'user.project_index' ? 'active' : '' }}">
                            <a href="{{ route('user.project_index') }}" class="menu-link">
                    ...
                    @if (optional(Auth::user()->page_role)->invoice == 1)
                        <li
                            class="menu-item 
                    {{ in_array(Route::currentRouteName(), ['user.invoice.index', 'user.invoice.create', 'user.invoice.deleted','user.invoice.update']) ? 'active' : '' }} 
                    {{ in_array(Route::currentRouteName(), ['user.invoice.index', 'user.invoice.create', 'user.invoice.deleted','user.invoice.update']) ? 'open' : '' }}">
                            <a href="javascript:void(0);" class="menu-link menu-toggle">
                                <i class="menu-icon ri-group-line"></i>
                                <div>Invoice</div>
                            </a>
                            <ul class="menu-sub">
                                <!-- Only activate Invoice List when on user.invoice.index -->
                                <li
                                    class="menu-item {{ in_array(Route::currentRouteName(), ['user.invoice.index', 'user.invoice.create','user.invoice.update']) ? 'active' : '' }}">
                                    <a href="{{ route('user.invoice.index') }}" class="menu-link">
                            ...
                            <ul class="menu-sub">
                                <li
                                    class="menu-item {{ Route::currentRouteName() == 'user.invoice.deleted' ? 'active' : '' }}">
                                    <a href="{{ route('user.invoice.deleted') }}" class="menu-link">
                    ...
                    @if (optional(Auth::user()->page_role)->company_progress == 1)
                        <li
                            class="menu-item {{ Route::currentRouteName() == 'user.company_progress' ? 'active' : '' }}">
                            <a href="{{ route('user.company_progress') }}" class="menu-link">
