                                ...
                                <div class="card-body" style="padding:11%">
                                    <div class="text-center">
                                        <h4 style="font-family: cursive;">
                                            Wishing you a happy birthday, a wonderful year and success in all you do.<br><br>
                                            <div style="color: burlywood;">PlaceCode Family</div>
                                        </h4>
                                        <img src="{{ asset('assets/img/favicon/birthday.gif') }}" alt="chart success" style="width:115%">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row row-bordered g-0">
                            ...
                            <div class="col-md-4">
                                <div class="card-body" style="padding:11%">
                                    <div class="text-center">
                                        <h4 style="font-family: cursive;">
                                            Mark your calendars for {{ Carbon\Carbon::parse($upcomingBirthdayFirst->emp_birthday_date)->format('F d') }}!<br><br>
                                            <div style="color: burlywood;">PlaceCode Family</div>
                                        </h4>
                                        <img src="{{ asset('assets/img/favicon/birthday.gif') }}" alt="chart success" style="width:115%">
                                    </div>
