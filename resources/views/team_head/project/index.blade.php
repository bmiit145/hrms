                ...
                <form action="{{ route('admin.project.payment') }}" method="post" id="paymnetForm"
                    ...
                    <div class="col-sm-12 fv-plugins-icon-container mt-5">
                        <div class="input-group input-group-merge">
                            <span id="basicFullname2" class="input-group-text"><i class="ri-calendar-2-line"></i></span>
                            <div class="form-floating form-floating-outline">
                                <input type="date" class="form-control dob-picker" placeholder="Select Paymnet Date"
                    ...
                    <div class="col-sm-12 fv-plugins-icon-container mt-5">
                        <div class="input-group input-group-merge">
                            ...
                            <div class="form-floating form-floating-outline">
                                <input type="number" class="form-control" placeholder="Enter Total Paymnet"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control dob-picker" placeholder="Select Paymnet Date"
                                    name="payment_date" id="paymentDate" />
                            </div>
                            <div class="mb-3">
