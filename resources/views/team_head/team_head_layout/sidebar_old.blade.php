                    ...
                    <li class="menu-item active open">
                            ...
                            <ul class="menu-sub">
                                <li class="menu-item">
                                    <a href="{{route('teamHead.teamHead_employee_list')}}" class="menu-link">
                                        <div data-i18n="Without menu">Employee Details List</div>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="menu-item">
                            ...
                            <ul class="menu-sub">
                                ...
                                <li class="menu-item">
                                    <a href="{{route('teamHead.teamHead_empolyee_attendance_list')}}" class="menu-link">
                                        <div data-i18n="Without menu">Employee Attendance List</div>
                                    </a>
                                </li>
                                <li class="menu-item">
                            ...
                            <ul class="menu-sub">
                                <li class="menu-item">
                                    <a href="{{route('teamHead.teamHead_empolyee_leave_list')}}"  class="menu-link">
                                        <div data-i18n="Without menu">Employee Leave List</div>
                                    </a>
                                </li>  
                            </ul>
                            <ul class="menu-sub">
                                <li class="menu-item">
                                    <a href="{{route('teamHead.teamHead_leave')}}" class="menu-link">
                                        <div data-i18n="Without menu">Add Leave Requests </div>
                                    </a>
                                </li>  
                            </ul>
                        </li>
