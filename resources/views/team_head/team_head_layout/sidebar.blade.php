        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    <!-- Dashboards -->
                    <li class="menu-item {{ Route::currentRouteName() == 'teamhead.dahsboard' ? 'active' : '' }}">
                        <a href="{{ route('teamhead.dahsboard') }}" class="menu-link">
                    ...
                    <li
                        class="menu-item 
                    {{ in_array(Route::currentRouteName(), ['teamHead.teamHead_employee_list', 'teamHead.teamHead_employee_view']) ? 'active' : '' }} 
                    {{ in_array(Route::currentRouteName(), ['teamHead.teamHead_employee_list', 'teamHead.teamHead_employee_view']) ? 'open' : '' }}">
                        ...
                        <ul class="menu-sub">
                            <li
                                class="menu-item {{ in_array(Route::currentRouteName(), ['teamHead.teamHead_employee_list', 'teamHead.teamHead_employee_view']) ? 'active' : '' }}">
                                <a href="{{ route('teamHead.teamHead_employee_list') }}" class="menu-link">
                    ...
                    <li
                        class="menu-item {{ Route::currentRouteName() == 'teamHead.teamHead_attendance_list' || Route::currentRouteName() == 'teamHead.teamHead_empolyee_attendance_list' || Route::currentRouteName() == 'teamHead.teamHead_attendance_sheet' ? 'active' : '' }} 
                                            {{ Route::currentRouteName() == 'teamHead.teamHead_attendance_list' || Route::currentRouteName() == 'teamHead.teamHead_empolyee_attendance_list' || Route::currentRouteName() == 'teamHead.teamHead_attendance_sheet' ? 'open' : '' }}">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                        ...
                        <ul class="menu-sub">
                            <li
                                class="menu-item {{ Route::currentRouteName() == 'teamHead.teamHead_attendance_list' ? 'active' : '' }}">
                                <a href="{{ route('teamHead.teamHead_attendance_list') }}" class="menu-link">
                                    <div>Today Attendance</div>
                                </a>
                            </li>
                            <li
                                class="menu-item {{ Route::currentRouteName() == 'teamHead.teamHead_empolyee_attendance_list' ? 'active' : '' }}">
                                <a href="{{ route('teamHead.teamHead_empolyee_attendance_list') }}"
                                    class="menu-link">
                                    <div>Employee Attendance List</div>
                                </a>
                            </li>
                            <li
                                class="menu-item {{ Route::currentRouteName() == 'teamHead.teamHead_attendance_sheet' ? 'active' : '' }}">
                                <a href="{{ route('teamHead.teamHead_attendance_sheet') }}" class="menu-link">
                    ...
                    <li
                        class="menu-item {{ Route::currentRouteName() == 'teamHead.teamHead_empolyee_leave_list' || Route::currentRouteName() == 'teamHead.teamHead_leave' ? 'active' : '' }} 
                                            {{ Route::currentRouteName() == 'teamHead.teamHead_empolyee_leave_list' || Route::currentRouteName() == 'teamHead.teamHead_leave' ? 'open' : '' }}">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                        ...
                        <ul class="menu-sub">
                            <li
                                class="menu-item {{ Route::currentRouteName() == 'teamHead.teamHead_empolyee_leave_list' ? 'active' : '' }}">
                                <a href="{{ route('teamHead.teamHead_empolyee_leave_list') }}" class="menu-link">
                                    <div>Employee Leave List</div>
                                </a>
                            </li>
                        </ul>
                        <ul class="menu-sub">
                            <li
                                class="menu-item {{ Route::currentRouteName() == 'teamHead.teamHead_leave' ? 'active' : '' }}">
                                <a href="{{ route('teamHead.teamHead_leave') }}" class="menu-link">
                                    <div>Add Leave Requests </div>
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    @if (optional(Auth::user()->page_role)->client_data == 1 || optional(Auth::user()->page_role)->client_income == 1)
                        <li
                            class="menu-item {{ Route::currentRouteName() == 'teamhead.Client_view' ? 'active' : '' }} {{ Route::currentRouteName() == 'teamhead.Client_view' || Route::currentRouteName() == 'teamhead.Clinetincome' ? 'open' : '' }}">
                            <a href="javascript:void(0);" class="menu-link menu-toggle">
                            ...
                            @if (optional(Auth::user()->page_role)->client_data == 1)
                                <ul class="menu-sub">
                                    <li
                                        class="menu-item {{ Route::currentRouteName() == 'teamhead.Client_view' ? 'active' : '' }}">
                                        <a href="{{ route('teamhead.Client_view') }}" class="menu-link">
                                            <div>Client Data</div>
                                        </a>
                                    </li>
                                </ul>
                            ...
                            @if (optional(Auth::user()->page_role)->client_income == 1)
                                <ul class="menu-sub">
                                    <li
                                        class="menu-item {{ Route::currentRouteName() == 'teamhead.Clinetincome' ? 'active' : '' }}">
                                        <a href="{{ route('teamhead.Clinetincome') }}" class="menu-link">
                    ...
                    @if (optional(Auth::user()->page_role)->project_data == 1)
                        <li
                            class="menu-item {{ Route::currentRouteName() == 'teamhead.project_index' ? 'active' : '' }}">
                            <a href="{{ route('teamhead.project_index') }}" class="menu-link">
                    ...
                    @if (optional(Auth::user()->page_role)->invoice == 1)
                        <li
                            class="menu-item 
                        {{ in_array(Route::currentRouteName(), ['teamhead.invoice.index', 'teamhead.invoice.create', 'teamhead.invoice.deleted','teamhead.invoice.update']) ? 'active' : '' }} 
                        {{ in_array(Route::currentRouteName(), ['teamhead.invoice.index', 'teamhead.invoice.create', 'teamhead.invoice.deleted','teamhead.invoice.update']) ? 'open' : '' }}">
                            <a href="javascript:void(0);" class="menu-link menu-toggle">
                                <i class="menu-icon ri-group-line"></i>
                                <div>Invoice</div>
                            </a>
                            <ul class="menu-sub">
                                <!-- Only activate Invoice List when on admin.invoice.index -->
                                <li
                                    class="menu-item {{ in_array(Route::currentRouteName(), ['teamhead.invoice.index', 'teamhead.invoice.create','teamhead.invoice.update']) ? 'active' : '' }}">
                                    <a href="{{ route('teamhead.invoice.index') }}" class="menu-link">
                            ...
                            <ul class="menu-sub">
                                <li
                                    class="menu-item {{ Route::currentRouteName() == 'teamhead.invoice.deleted' ? 'active' : '' }}">
                                    <a href="{{ route('teamhead.invoice.deleted') }}" class="menu-link">
                    ...
                    @if (optional(Auth::user()->page_role)->company_progress == 1)
                        <li
                            class="menu-item {{ Route::currentRouteName() == 'teamhead.company_progress' ? 'active' : '' }}">
                            <a href="{{ route('teamhead.company_progress') }}" class="menu-link">
                        ...
                        <ul class="navbar-nav flex-row align-items-center ms-auto" style="gap:5px">
                            ...
                            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end mt-3 py-2">
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="{{ route('teamhead.profile.edit') }}">
