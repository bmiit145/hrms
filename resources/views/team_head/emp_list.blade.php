        ...
        <div class="card">
            <div class="card-datatable table-responsive pt-0 h-100">
                <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                    ...
                    <form method="GET" action="{{ route('teamHead.teamHead_empolyee_attendance_list') }}">
                        <div class="row">
                            <div class="col-md-3">
    ...
    'year' => request('year', Carbon\Carbon::now()->year),
                                ...
                                <tr>
                                    <td class="employee-name" style="white-space: nowrap;">
                                        <strong>{{ $employeeName }}</strong></td>
                                    <td class="employee-name">
                                        <strong>{{ $attendances->first()->get_emp_name->monthly_selery }}</strong></td>
                                    @foreach (range(1, $daysInMonth) as $day)
                                        @php
                                            $currentDate = Carbon\Carbon::createFromDate(
                                                request('year', Carbon\Carbon::now()->year),
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('.refresh-btn').click(function(event) {
                ...
                var url = "{{ route('teamHead.teamHead_empolyee_attendance_list') }}";
